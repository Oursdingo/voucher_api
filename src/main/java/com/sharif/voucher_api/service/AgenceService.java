...
public class AgenceService {
    ...
    public AgenceResponse create(AgenceCreateRequest request) {
        ...
        AgenceEntity entity = agenceMapper.toEntity(request);
        AgenceEntity saved = agenceRepository.save(entity);
    ...
    public AgenceResponse update(AgenceUpdateRequest request) {
        AgenceEntity entity = agenceRepository.findById(request.getId())
    ...
    public void delete(UUID id) {
        AgenceEntity entity = agenceRepository.findById(id)
                .orElseThrow(() -> new NotFoundException("Agence not found"));
    ...
    private void assignPointVentes(AgenceEntity agence, List<UUID> pointVenteIds) {
